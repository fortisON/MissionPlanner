...
namespace MissionPlanner.GCSViews
{
    public partial class FlightData : MyUserControl, IActivate, IDeactivate
    {
        ...
        private void updateDisplayTabControlActions()
        {
            ...
            TabListDisplay.Add(tabMain.Name, MainV2.DisplayConfiguration.displayAdvMainTab);
        ...
        private void BUT_Main_Click(object sender, EventArgs e)
        {
            CustomMessageBox.Show("Good");
        }
